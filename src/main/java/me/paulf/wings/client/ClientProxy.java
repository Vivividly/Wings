...
public final class ClientProxy extends Proxy {
    ...
    public void init(IEventBus modBus) {
        ...
        modBus.<FMLClientSetupEvent>addListener(e -> {
            ...
            WingForm.register(WingsMod.ANGEL_WINGS.get(), this.createAvianWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.ANGEL_WINGS.get())));
            WingForm.register(WingsMod.PARROT_WINGS.get(), this.createAvianWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.PARROT_WINGS.get())));
            WingForm.register(WingsMod.BAT_WINGS.get(), this.createAvianWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.BAT_WINGS.get())));
            WingForm.register(WingsMod.BLUE_BUTTERFLY_WINGS.get(), this.createInsectoidWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.BLUE_BUTTERFLY_WINGS.get())));
            WingForm.register(WingsMod.DRAGON_WINGS.get(), this.createAvianWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.DRAGON_WINGS.get())));
            WingForm.register(WingsMod.EVIL_WINGS.get(), this.createAvianWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.EVIL_WINGS.get())));
            WingForm.register(WingsMod.FAIRY_WINGS.get(), this.createInsectoidWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.FAIRY_WINGS.get())));
            WingForm.register(WingsMod.FIRE_WINGS.get(), this.createAvianWings(WingsMod.WINGS_REGISTRY.get().getKey(WingsMod.FIRE_WINGS.get())));
