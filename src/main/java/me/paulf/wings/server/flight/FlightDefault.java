...
public final class FlightDefault implements Flight {
    ...
    public void serialize(FriendlyByteBuf buf) {
        ...
        buf.writeUtf(WingsMod.WINGS_REGISTRY.get().getKey(this.getWing()).toString());
    }
    ...
    public void deserialize(FriendlyByteBuf buf) {
        ...
        this.setWing(WingsMod.WINGS_REGISTRY.get().getValue(ResourceLocation.tryParse(buf.readUtf(64))));
    }
    ...
    public static final class Serializer implements NBTSerializer<FlightDefault, CompoundTag> {
        ...
        public CompoundTag serialize(FlightDefault instance) {
            ...
            compound.putString(WING, WingsMod.WINGS_REGISTRY.get().getKey(instance.getWing()).toString());
            return compound;
        }
        ...
        public FlightDefault deserialize(CompoundTag compound) {
            ...
            f.setWing(WingsMod.WINGS_REGISTRY.get().getValue(ResourceLocation.tryParse(compound.getString(WING))));
            return f;
        }
    }
